...
<link href='/easyData/js/bootstrap/css/bootstrap.css?updateTS=1721425849' rel='stylesheet' type='text/css' />
<link href='/easyData/js/bootstrap/css/bootstrap-theme.css?updateTS=1721425849' rel='stylesheet' type='text/css' />
<script src='/easyData/js/jquery/jquery.min.js?updateTS=1721425849' language='JavaScript' type='text/JavaScript'></script>
<script src='/easyData/js/bootstrap/js/bootstrap.js?updateTS=1721425849' language='JavaScript' type='text/JavaScript'></script>
<link href='/easyData/js/bootstrap-select/dist/css/bootstrap-select.min.css?updateTS=1721425849' rel='stylesheet' type='text/css' />
<script src='/easyData/js/bootstrap-select/dist/js/bootstrap-select.js?updateTS=1721425849' language='JavaScript' type='text/JavaScript'></script>
<script src='/easyData/js/bootstrap-select/dist/js/i18n/defaults-pt_BR.min.js?updateTS=1721425849' language='JavaScript' type='text/JavaScript'></script>
...
<div class="row">
  <div class="col-sm-12">
    <div class="form-group">
      <label><code>width: '250px'</code></label>
      <select class="selectpicker form-control" data-width="250px">
        <option>Mustard</option>
        <option>Ketchup</option>
        <option>Relish</option>
        <option>All of the above (and much, much more!)</option>
