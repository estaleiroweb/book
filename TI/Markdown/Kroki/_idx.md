...
<https://kroki.io/examples.html#commit-graph>
...
```kroki-bytefield
    ...
    (draw-box 0x11:bg-white)
    (draw-box 0x2104 [{:span 4} :bg-white])
    (draw-box 0x11:bg-white)
    (draw-box 0 [{:span 4} :bg-white])
    (draw-box 0x11:bg-white)
    (draw-box (text "length" [:math] [:sub 1]) [{:span 4} :bg-white])
    (draw-box 0x14:bg-white)

    (draw-box (text "length" [:math] [:sub 1]) [{:span 4} :bg-white])
    (draw-gap "Cue and loop point bytes" :bg-white)

    (draw-box nil :box-below)
    (draw-box 0x11 :bg-white)
    (draw-box 0x36 {:span 4})
    (draw-box 0x11 :bg-white)
    (draw-box (text "num" [:math] [:sub "hot"]) [{:span 4} :bg-white])
    (draw-box 0x11 :bg-white)
    (draw-box (text "num" [:math] [:sub "cue"]) [{:span 4} :bg-white])

    (draw-box 0x11 :bg-white)
    (draw-box (text "length" [:math] [:sub 2]) [{:span 4} :bg-white])
    (draw-box 0x14 :bg-white)
    (draw-box (text "length" [:math] [:sub 2]) [{:span 4} :bg-white])
