...
## Messages 1xx Respostas de informação
100 Continue
...
## Messages 2xx Respostas de sucesso
- Method
...
## Messages 3xx Redirecionamentos
300 Multiple Choice
...
421 Misdirected Request [Danger]
...
423 Locked (WebDAV (en-US)) [Danger]
> O recurso sendo acessado está travado.

424 Failed Dependency (WebDAV (en-US)) [Danger]
...
## Messages 5xx Erros do servidor
